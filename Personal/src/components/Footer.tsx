            ...
            <div className='inline-flex'>
              <a
                ...
                >
                    ...
                    <svg className="h-10 w-10 transition-all duration-300 ease-in-out fill-bg hover:fill-a hover:cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
